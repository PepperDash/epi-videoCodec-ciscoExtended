...
namespace epi_videoCodec_ciscoExtended
{
    public class CiscoCodecJoinMap : VideoCodecControllerJoinMap
    {
        ...
        public JoinDataComplete DialActiveMeeting = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Dial Active Meeting",
        ...
        /* TODO: These extra use cases may be required someday
        ...
        */
        ...
        [JoinName("WebexPinNotRequested")]
        public JoinDataComplete WebexPinNotRequested = new JoinDataComplete(
            new JoinData
            {
                JoinNumber = 318,
                JoinSpan = 1
            ...
            new JoinMetadata
            {
                Description = "WebexPinNotRequested",
                JoinCapabilities = eJoinCapabilities.ToSIMPL,
                JoinType = eJoinType.Digital
            });

        [JoinName("WebexPinInput")]
        public JoinDataComplete WebexPinInput = new JoinDataComplete(
            new JoinData
            {
                JoinNumber = 311,
                JoinSpan = 1
